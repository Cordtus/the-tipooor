...
exports.ModuleSchemaDescriptor_FileEntry = exports.ModuleSchemaDescriptor = exports.StorageType = void 0;
...
protobuf_1.proto3.util.setEnumType(StorageType, "cosmos.orm.v1alpha1.StorageType", [
 ...
 */
class ModuleSchemaDescriptor extends protobuf_1.Message {
    constructor(data) {
        super();
        /**
    ...
    static equals(a, b) {
        return protobuf_1.proto3.util.equals(ModuleSchemaDescriptor, a, b);
    }
}
exports.ModuleSchemaDescriptor = ModuleSchemaDescriptor;
ModuleSchemaDescriptor.runtime = protobuf_1.proto3;
ModuleSchemaDescriptor.typeName = "cosmos.orm.v1alpha1.ModuleSchemaDescriptor";
ModuleSchemaDescriptor.fields = protobuf_1.proto3.util.newFieldList(() => [
 ...
 */
class ModuleSchemaDescriptor_FileEntry extends protobuf_1.Message {
    constructor(data) {
        super();
        /**
    ...
    static equals(a, b) {
        return protobuf_1.proto3.util.equals(ModuleSchemaDescriptor_FileEntry, a, b);
    }
}
exports.ModuleSchemaDescriptor_FileEntry = ModuleSchemaDescriptor_FileEntry;
ModuleSchemaDescriptor_FileEntry.runtime = protobuf_1.proto3;
ModuleSchemaDescriptor_FileEntry.typeName = "cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry";
ModuleSchemaDescriptor_FileEntry.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 13 /* ScalarType.UINT32 */ },
    { no: 2, name: "proto_file_name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "storage_type", kind: "enum", T: protobuf_1.proto3.getEnumType(StorageType) },
]);
